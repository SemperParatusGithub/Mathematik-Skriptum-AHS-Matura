...
\draw[line width=.4mm] (13,0) coordinate (A) --node[midway,below]{}
        ...
        cycle;
\pic[pic text=$\alpha$,draw=accent,thick,angle radius=.8cm] {angle=B--A--C};
\pic[pic text=$\beta$,draw=accent,thick,angle radius=.8cm] {angle=C--B--A};
\pic[pic text=$\gamma$,draw=accent,thick,angle radius=.7cm] {angle=A--C--B};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=.9, >=stealth]
  \draw[thick] (0,0) coordinate[label=below left:$A$] (A) --node[midway,below]{c}
        ...
        (4,4) coordinate[label=above:$C$] (C) --node[midway,above left]{b}
        cycle;
        \pic[pic text=$\alpha$,draw=accent,thick,angle radius=1cm] {angle=B--A--C};
        \pic[pic text=$\beta$,draw=accent,thick,angle radius=1cm] {angle=C--B--A};
        \pic[pic text=$\gamma$,draw=accent,thick,angle radius=1cm] {angle=A--C--B};
\end{tikzpicture}
\end{minipage}
\\
...
\begin{tikzpicture}[scale=0.84, >=stealth]
  \draw[thick] (0,0) coordinate (A) --node[midway,below, sloped]
        ...
        cycle;
        \pic[pic text=$\alpha$,draw=accent,thick,angle radius=1.5cm] {angle=B--A--C};
        \pic[pic text=$90^\circ$,draw=black,thick,angle radius=1cm] {angle=C--B--A};
\end{tikzpicture}
\end{minipage}
\vspace{12pt}
\\
